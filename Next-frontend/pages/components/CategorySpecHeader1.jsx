...
const CategorySpecHeader1 = () => {
  return (
    <>


    
            <div  className=" px-4 xl:px-0 py-12 w-9/12 m-auto">
                <div className="mx-auto container">
                    <h1 className="text-center text-3xl text-gray-900">Welcome to the World of Productivity</h1>
                            ...
                            <div>
                                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <div className="py-2 px-4 w-full flex justify-between bg-indigo-500">
                                        ...
                                        <div className="bg-white px-3  lg:px-6 py-4 rounded-bl-3xl rounded-br-3xl">
                                            <h1 className="text-lg text-gray-900 font-semibold ">Transactions</h1>
                                            <p className="text-gray-700 text-sm  lg:text-base   pr-4  mt-2">Find the latest events updates or create events, concerts, conferences, workshops...</p>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="bg-white px-3  lg:px-6 py-4 rounded-bl-3xl rounded-br-3xl">
                                            <h1 className="text-lg text-gray-900 font-semibold ">Transactions</h1>
                                            <p className="text-gray-700 text-sm  lg:text-base  pr-4 tracking-wide mt-2">Find the latest events updates or create events, concerts, conferences, workshops...</p>
                                        </div>
                                    </div>
                                </div>
...
export default CategorySpecHeader1
